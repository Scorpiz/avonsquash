    	...
    	<div class="row">
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    <!-- Main menu -->
                    <li class="current"><a href="admin.php"><i class="glyphicon glyphicon-home"></i>Accueil</a></li>
                    ...
                    <li><a href="tables.html"><i class="glyphicon glyphicon-list"></i> Partenaire</a></li>
